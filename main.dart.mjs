...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1433: (x0,x1) => x0.exec(x1),
      _1434: (x0,x1) => x0.test(x1),
      _1435: x0 => x0.pop(),
      _1437: o => o === undefined,
      _1439: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1441: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1442: o => o instanceof RegExp,
      _1443: (l, r) => l === r,
      _1444: o => o,
      _1445: o => o,
      _1446: o => o,
      ...
      _1448: o => o.length,
      _1450: (o, i) => o[i],
      _1451: f => f.dartFunction,
      _1452: () => ({}),
      _1453: () => [],
      _1455: () => globalThis,
      _1456: (constructor, args) => {
      ...
      _1458: (o, p) => o[p],
      _1459: (o, p, v) => o[p] = v,
      _1460: (o, m, a) => o[m].apply(o, a),
      _1462: o => String(o),
      _1463: (p, s, f) => p.then(s, f),
      _1464: o => {
      ...
      _1465: o => [o],
      _1466: (o0, o1) => [o0, o1],
      _1467: (o0, o1, o2) => [o0, o1, o2],
      _1468: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      ...
      _1482: x0 => x0.index,
      _1484: x0 => x0.flags,
      _1485: x0 => x0.multiline,
      _1486: x0 => x0.ignoreCase,
      _1487: x0 => x0.unicode,
      _1488: x0 => x0.dotAll,
      _1489: (x0,x1) => x0.lastIndex = x1,
      _1490: (o, p) => p in o,
      _1491: (o, p) => o[p],
      _1494: x0 => x0.random(),
      _1497: () => globalThis.Math,
      _1498: Function.prototype.call.bind(Number.prototype.toString),
      _1499: Function.prototype.call.bind(BigInt.prototype.toString),
      _1500: Function.prototype.call.bind(Number.prototype.toString),
      _1501: (d, digits) => d.toFixed(digits),
      _1505: () => globalThis.document,
      _1506: () => globalThis.window,
      _1511: (x0,x1) => x0.height = x1,
      _1513: (x0,x1) => x0.width = x1,
      _1516: x0 => x0.head,
      _1517: x0 => x0.classList,
      _1521: (x0,x1) => x0.innerText = x1,
      _1522: x0 => x0.style,
      _1524: x0 => x0.sheet,
      _1535: x0 => x0.offsetX,
      _1536: x0 => x0.offsetY,
      _1537: x0 => x0.button,
      _3379: () => globalThis.window,
...
"hardEdge",
"DragStartBehavior.",
"assets/lottie/jellyLottie.json",
"(bundle: ",
", name: \"",
"rectangle",
"BoxShape.",
...
"isEnabled",
"_invertColors",
"assets/icons/wp.webp",
"_scaleAnimation",
"regular",
"_FloatingActionButtonType.",
"extended",
"_textTheme",
"https://wa.me/1789428209",
"New Tab",
...
"Familiar with Layered and Clean Architecture ",
"Familiar with Node.js and Go Backend Tech",
"Basic experience with MongoDB, Docker and AWS",
"Writing Clean, Maintainable and Scalable code",
"assets/images/skill.webp",
"Skills In Flutter :",
"Understanding of Dart OOP",
"Proficient in Flutter Framework",
"Responsive & Adaptive UI Design",
"State Management (Get-x, Provider, Riverpod)",
"REST API Integration",
"Local Database & Caching",
"Google Map Integration",
"Firebase Push Notification",
"Firebase Authentication & CRUD",
...
"assets/images/ecom_ui.webp",
"https://drive.google.com/drive/folders/1K8BsOiFdQnMvQ4681hyq6VBCCwVw5cHt?usp=drive_link",
"ParcelFly",
"Deliveryman App",
"ParcelFly is an app where deilveryman can see pending, delivered and returned percel list and change the status of parcels.",
"assets/images/parcelfly.png",
"assets/images/parcelfly_ui.webp",
"https://delivery.bugbuild.com/",
"Task Manager",
"Task management App",
"Task management app is a tool used to streamline all the processes involved in creating, updating, and completing tasks.",
"assets/images/task_manager.png",
"assets/images/taskman_ui.webp",
"https://drive.google.com/drive/folders/1x4v524Rnsv1U5elG4Dcu60NQiVjGEA9N?usp=drive_link",
"ChatUp",
"Chatting App",
"It enables you to send and receive messages. This apps make it easier, simpler to connect with everyone and it is also easy to use.",
"assets/images/chatup.png",
"assets/images/chatapp_ui.webp",
"https://drive.google.com/drive/folders/1cKFIqoSHQAXDj5l0uH2mP52_zw_8pM1I?usp=drive_link",
"Moovi",
"Movie App",
"This app is based on The Movie Database (TMDB) API. A friendly app makes it easy to browse through popular movie and Tv lists.",
"assets/images/moovi.png",
"assets/images/movie_ui.webp",
"https://drive.google.com/drive/folders/189NEwvAYjGL6-GBMGiGaQjoaKj6BsvYx?usp=drive_link",
"Weather",
"Weather App",
"This Weather App based on openweather API, to predict the conditions of the atmosphere based on the user's device location",
"assets/images/weather.png",
"assets/images/weather_ui.webp",
"https://drive.google.com/drive/folders/1HuAVO-zAdoxdhv14Ywp0h_DQ4hFtcMWf?usp=drive_link",
"TuneTrail",
"Music player",
"This music player application allows you to listen to audio files stored in the phone's internal or external memory. Have a chill!",
"assets/images/tunetrail.png",
"assets/images/musicplayer_ui.webp",
"https://drive.google.com/drive/folders/1mI3L3glRZYuZ1ERJIOwJcOQNTu7dL1xU?usp=drive_link",
"practice",
"ProjectType.",
"live",
"View Live",
...
"HELF AI",
"Healthcare AI",
"assets/images/helf_ai.png",
"https://play.google.com/store/apps/details?id=co.vearth.helf&hl=en",
"HELF Buddy",
"AI-Based Healthcare",
"assets/images/helf_buddy.png",
"https://play.google.com/store/apps/details?id=co.vearth.helfbuddy&hl=en",
"GroFresh",
"Grocery App",
"assets/images/grofresh.png",
"https://codecanyon.net/item/grofresh-grocery-pharmacy-ecommerce-store-app-and-web-with-laravel-admin-panel-delivery-app/32791631?s_rank=21",
"StackFood",
"Restaurant App",
"assets/images/stackfood.png",
"https://codecanyon.net/item/stackfood-multi-restaurant-food-delivery-app-with-laravel-admin-and-restaurant-panel-v10/33571750?s_rank=20",
"SixValley",
"assets/images/sixvalley.png",
"https://codecanyon.net/item/6valley-multivendor-ecommerce-complete-ecommerce-mobile-app-web-and-admin-panel/31448597?s_rank=22",
"JobNect",
"Job Portal App",
"assets/images/jobnect.png",
"https://codecanyon.net/item/jobnect-the-job-seeking-finding-applicant-app/54309349",
"Work Experiences :",
"Software Engineer",
"Apr 2025 - Present",
...
"Oct 2024 - Jan 2025",
"Full-Time - Onsite, Mirpur DOHS",
"https://6amtech.com",
"BugBuild Lab",
"Flutter Developer",
"Apr 2024 - Jul 2024",
"Full-Time - Remote, Feni",
"https://www.bugbuild.com",
"View Company",
"assets/images/znd.webp",
"I’m a software developer with 1+ year of experience creating scalable, user-focused apps using Flutter and modern technologies. I bridge design, functionality, and performance to build meaningful digital experiences.",
"Hi, I'm Zunayed !",
"Find me 👉🏻",
"assets/icons/ln.webp",
"https://www.linkedin.com/in/zunaedef",
"assets/icons/git.webp",
"https://www.github.com/MdZunaed",
"assets/icons/up.webp",
"https://www.upwork.com/freelancers/~0167d503217fe0bfc3",
"onDrag",
